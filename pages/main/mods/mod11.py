...
def comparacion11():
        ...
        c19989, c19979, c19969 = st.columns([0.1,0.8,0.1])

        with c19979:

            sac.divider(label='', icon=None, align='center', key='67532')
            st.markdown("<h2 style='text-align: center;'>PASO VS. GENERALES<br></h2>", unsafe_allow_html=True)
            ...
            distritos_id = st.selectbox("Seleccioná el distrito:", list(distritos.keys()), index=None, placeholder="")
...
def datosextra11():
                    ...
                    tabs_parti = sac.buttons(['Nacional','Por provincia','Por sección'], label=None, index=0, format_func=None, align='center', position='top', size='large', direction='horizontal', shape='round', compact=False, return_index=False)
